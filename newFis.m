...
ud_E = [-1 1]; ud_dE = [-1 1];%universo de discurso ganho 8 e 10
...
fis = addMF(fis,'dE','trimf',[-20/10 -10/10 -5/10],'Name','NP');
fis = addMF(fis,'dE','trimf',[-10/10 -5/10 0],'Name','NE');
fis = addMF(fis,'dE','trimf',[-5/10 0 5/10],'Name','ZO');
fis = addMF(fis,'dE','trimf',[0 5/10 10/10],'Name','PO');
fis = addMF(fis,'dE','trimf',[5/10 10/10 20/10],'Name','PP');
